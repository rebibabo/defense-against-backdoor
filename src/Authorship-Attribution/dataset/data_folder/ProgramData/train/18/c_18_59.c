...
void r(int m)                                                         //&ordm;&macr;&Ecirc;&yacute;&Oacute;&Atilde;&Agrave;&acute;&Aacute;&ETH;&sup1;&Aacute;&atilde;
{
	int x, y, min;
	for(x = 0; x < m; x++)
	{
...
void l(int m)                                                        //&ordm;&macr;&Ecirc;&yacute;&Oacute;&Atilde;&Agrave;&acute;&ETH;&ETH;&sup1;&Aacute;&atilde;
{
	int x, y, min;
	for(y = 0; y < m; y++)
	{
