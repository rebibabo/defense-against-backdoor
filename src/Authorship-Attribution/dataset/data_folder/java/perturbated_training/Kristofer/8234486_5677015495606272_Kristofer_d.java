 ...
 public class D {
     ...
     public class Solver {
         ...
         private int solve(int R, int C) {
             int ans1 = solveTwos(R, C);
             int ans2 = solveThrees(R, C);
             return ans1 + ans2;
         }
 
         private int solveTwos(int R, int C) {
             if (R == 1) {
                 return 1;
             }
             if (C == 6) {
                 ...
                 return 6 * solveThrees(R - 1, C);
             } else {
                 if (R == 2) {
                     return 0;
                 }
                 return solveThrees(R - 1, C);
             }
         }
 
         private int solveThrees(int R, int C) {
             if (R == 1) {
                 return 0;
             }
             if (R == 2) {
