     ...
     static class TaskA {
         public void solve(int testNumber, InputReader in, OutputWriter out) {
             Scheduler scheduler = new Scheduler(in, out, () -> new Task() {
                 ...
                 public void solve() {
                     MiscUtils.decreaseByOne(d);
                     boolean[] has = new boolean[1000000];
                     for (int i = 0; i < n; i++) {
                         for (int j : d[i]) {
                             has[j] = true;
                         }
                     ...
                     for (int j = 0; j < 1000000; j++) {
                         ...
                         while (j + answer < 1000000 && has[j + answer]) {
                             Graph graph = new Graph(n + answer + 3);
                             ...
                             for (int i = 0; i < n; i++) {
                                 ...
                                 for (int k : d[i]) {
                                     if (k >= j && k <= j + answer) {
                                         graph.addFlowEdge(i, n + k - j, 1);
                                     }
                                 }
                             }
                             for (int i = 0; i <= answer; i++) {
                                 graph.addFlowEdge(n + i, sink, 1);
                             }
                             if (MaxFlow.dinic(graph, source, sink) != answer + 1) {
                                 break;
                             }
                             answer++;
                         }
                 ...
                 private boolean go(int position) {
