...
def program_transform(program_name, save_path):
...
def transfrom_include(program_path, author_path, ignore_list):
    new_ignore_list = []
    flag = False
...
def xml_file_path(xml_path):
    ...
    transform_java_file = './_pre_file/transform_c/include'
...
def program_transform_include(program_path, author_path, ignore_list=[]):
    flag, new_ignore_list = transfrom_include(program_path, author_path, ignore_list)
    save_tree_to_file(doc, './style/style.xml')
    return flag, doc, new_ignore_list


def program_transform_freopen(program_path, author_path, ignore_list=[]):
    flag_freopen = put_freopen('./style/style.xml', author_path)
    save_tree_to_file(doc, './style/style.xml')
    return flag_freopen


def program_transform_namespace(program_path, author_path, ignore_list=[]):
    flag_namespace = put_namespace('./style/style.xml', author_path)
    save_tree_to_file(doc, './style/style.xml')
    return flag_namespace


def program_transform_ios(program_path, author_path, ignore_list=[]):
    flag_ios = put_ios('./style/style.xml', author_path)
    save_tree_to_file(doc, './style/style.xml')
    return flag_ios


def program_transform_return(program_path, author_path, ignore_list=[]):
    flag_return = put_return('./style/style.xml', author_path)
    save_tree_to_file(doc, './style/style.xml')
    return flag_return
