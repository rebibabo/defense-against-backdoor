from style_change_method import while_for, for_while
...
def transform_random(program_style, program_name, save_path, converted_styles):
    if program_style['20.1'] == 0 and program_style['20.2'] == 0:
        return
    if program_style['20.1'] > program_style['20.2']:
        converted_styles.append('20')
        for_while.program_transform_save_div(program_name, save_path)
    else:
        converted_styles.append('20')
        while_for.program_transform_save_div(program_name, save_path)
