from style_change_method import var_init_pos
from style_change_method import var_init_merge
...
def transform_random(program_style, program_name, save_path, converted_styles):
    if program_style['7.1'] == 0 and program_style['7.2'] == 0:
        return
    if program_style['7.1'] > program_style['7.2']:
        converted_styles.append('7')
        var_init_pos.program_transform_save_div(program_name, save_path)
    else:
        converted_styles.append('7')
        var_init_merge.program_transform_save_div(program_name, save_path)
