from style_change_method import re_temp, temporary_var
...
def transform_random(program_style, program_name, save_path, converted_styles):
    if program_style['6.1'] == 0 and program_style['6.2'] == 0:
        return
    if program_style['6.1'] > program_style['6.2']:
        converted_styles.append('6')
        temporary_var.program_transform_save_div(program_name, save_path)
    else:
        converted_styles.append('6')
        re_temp.program_transform_save_div(program_name, save_path)
