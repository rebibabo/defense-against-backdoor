from style_change_method import dyn_static_mem
from style_change_method import static_dyn_mem
...
def transform_random(program_style, program_name, save_path, converted_styles):
    if program_style['19.1'] == 0 and program_style['19.2'] == 0:
        return
    if program_style['19.1'] > program_style['19.2']:
        converted_styles.append('19')
        static_dyn_mem.program_transform_save_div(program_name, save_path)
    else:
        converted_styles.append('19')
        dyn_static_mem.program_transform_save_div(program_name, save_path)
