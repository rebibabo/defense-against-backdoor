from style_change_method import cpp_lib_to_c
...
def transform_random(program_style, program_name, save_path, converted_styles):
    if program_style['18.1'] == 0 and program_style['18.2'] == 0:
        return
    if program_style['18.1'] > 0:
        converted_styles.append('18')
        cpp_lib_to_c.program_transform_save_div(program_name, save_path)
